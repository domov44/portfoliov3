...
const ImageText = ({ content }) => {
  ...
  return (
    <Section ref={sectionRef} highlight={content.variant}>
      ...
      <div className={styles.container + ' ' + (content.direction ? styles.container_row_reverse : styles.container_row)}>
        ...
        <div className={styles.content_wrapper}>
          ...
          {content.button && (
            <Button
              ...
              target={content.button.url.startsWith('https://') ? '_blank' : undefined}
